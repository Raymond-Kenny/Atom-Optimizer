...
namespace Atom_Optimizer
{
	public class power : Form
	{
		...
		private void guna2TileButton7_Click(object sender, EventArgs e)
		{
			...
			try
			{
				string text = Path.Combine(Path.GetTempPath(), "powerplan.bat");
				using (Stream stream = Assembly.GetExecutingAssembly().GetManifestResourceStream("Atom_Optimizer.powerplan.bat"))
				{
		...
		private void guna2TileButton1_Click(object sender, EventArgs e)
		{
			...
			try
			{
				string text = Path.Combine(Path.GetTempPath(), "power.bat");
				using (Stream stream = Assembly.GetExecutingAssembly().GetManifestResourceStream("Atom_Optimizer.power.bat"))
				{
					using (FileStream destination = new FileStream(text, FileMode.Create, FileAccess.Write))
					{
						stream.CopyTo(destination);
		...
		private void InitializeComponent()
		{
			...
			this.guna2TileButton1.Image = Atom_Optimizer.Properties.Resources.power_supply;
			this.guna2TileButton1.ImageSize = new System.Drawing.Size(53, 53);
			this.guna2TileButton1.Location = new System.Drawing.Point(489, 231);
			this.guna2TileButton1.Name = "guna2TileButton1";
			this.guna2TileButton1.Size = new System.Drawing.Size(163, 153);
			this.guna2TileButton1.TabIndex = 25;
			this.guna2TileButton1.Text = "Power Tweaks";
			...
			this.guna2TileButton7.Image = Atom_Optimizer.Properties.Resources.renewable_energy;
			this.guna2TileButton7.ImageSize = new System.Drawing.Size(53, 53);
			this.guna2TileButton7.Location = new System.Drawing.Point(278, 231);
			...
			this.guna2TileButton7.Text = "Power Plan";
