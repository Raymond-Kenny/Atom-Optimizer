...
namespace Atom_Optimizer
{
	public class gpu : Form
	{
		...
		private void guna2TileButton7_Click(object sender, EventArgs e)
		{
			...
			try
			{
				string text = Path.Combine(Path.GetTempPath(), "nvidia.bat");
				using (Stream stream = Assembly.GetExecutingAssembly().GetManifestResourceStream("Atom_Optimizer.nvidia.bat"))
				{
		...
		private void guna2TileButton1_Click(object sender, EventArgs e)
		{
			...
			try
			{
				string text = Path.Combine(Path.GetTempPath(), "amdgpu.bat");
		...
		private void InitializeComponent()
		{
			...
			this.guna2TileButton1.Image = Atom_Optimizer.Properties.Resources.amd_256x256;
			this.guna2TileButton1.ImageSize = new System.Drawing.Size(53, 53);
			this.guna2TileButton1.Location = new System.Drawing.Point(498, 257);
			this.guna2TileButton1.Name = "guna2TileButton1";
			this.guna2TileButton1.Size = new System.Drawing.Size(163, 153);
			this.guna2TileButton1.TabIndex = 29;
			this.guna2TileButton1.Text = "Redeon Tweaks";
			...
			this.guna2TileButton7.Image = Atom_Optimizer.Properties.Resources.nvidia;
			this.guna2TileButton7.ImageSize = new System.Drawing.Size(53, 53);
			this.guna2TileButton7.Location = new System.Drawing.Point(287, 257);
			...
			this.guna2TileButton7.Text = "Nvidia Tweaks";
