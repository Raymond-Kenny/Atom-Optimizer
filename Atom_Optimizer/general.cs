...
namespace Atom_Optimizer
{
	public class general : Form
	{
		...
		private void guna2TileButton7_Click(object sender, EventArgs e)
		{
			...
			try
			{
				string text = Path.Combine(Path.GetTempPath(), "general.bat");
				using (Stream stream = Assembly.GetExecutingAssembly().GetManifestResourceStream("Atom_Optimizer.general.bat"))
				{
		...
		private void InitializeComponent()
		{
			...
			this.label2.Text = "General Tweaks";
			...
			this.guna2TileButton7.Image = Atom_Optimizer.Properties.Resources.settings;
			this.guna2TileButton7.ImageSize = new System.Drawing.Size(53, 53);
			this.guna2TileButton7.Location = new System.Drawing.Point(387, 242);
			this.guna2TileButton7.Name = "guna2TileButton7";
			this.guna2TileButton7.Size = new System.Drawing.Size(163, 153);
			this.guna2TileButton7.TabIndex = 29;
			this.guna2TileButton7.Text = "General Tweaks";
