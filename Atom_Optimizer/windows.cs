...
namespace Atom_Optimizer
{
	public class windows : Form
	{
		...
		private void guna2TileButton1_Click(object sender, EventArgs e)
		{
			...
			try
			{
				string text = Path.Combine(Path.GetTempPath(), "advanced.bat");
				using (Stream stream = Assembly.GetExecutingAssembly().GetManifestResourceStream("Atom_Optimizer.advanced.bat"))
				{
		...
		private void guna2TileButton2_Click(object sender, EventArgs e)
		{
			...
			try
			{
				string text = Path.Combine(Path.GetTempPath(), "extreme.bat");
				using (Stream stream = Assembly.GetExecutingAssembly().GetManifestResourceStream("Atom_Optimizer.extreme.bat"))
				{
					using (FileStream destination = new FileStream(text, FileMode.Create, FileAccess.Write))
					{
						stream.CopyTo(destination);
		...
		private void guna2TileButton7_Click(object sender, EventArgs e)
		{
			...
			try
			{
				string text = Path.Combine(Path.GetTempPath(), "normal.bat");
				using (Stream stream = Assembly.GetExecutingAssembly().GetManifestResourceStream("Atom_Optimizer.normal.bat"))
				{
					using (FileStream destination = new FileStream(text, FileMode.Create, FileAccess.Write))
					{
						stream.CopyTo(destination);
		...
		private void InitializeComponent()
		{
			...
			this.label2.Text = "Windows Tweaks";
			...
			this.guna2TileButton2.Image = Atom_Optimizer.Properties.Resources.speedometer__2_;
			this.guna2TileButton2.ImageSize = new System.Drawing.Size(53, 53);
			this.guna2TileButton2.Location = new System.Drawing.Point(591, 245);
			this.guna2TileButton2.Name = "guna2TileButton2";
			this.guna2TileButton2.Size = new System.Drawing.Size(163, 153);
			this.guna2TileButton2.TabIndex = 30;
			this.guna2TileButton2.Text = "Extreme Tweaks";
			...
			this.guna2TileButton1.Image = Atom_Optimizer.Properties.Resources.speedometer__1_;
			this.guna2TileButton1.ImageSize = new System.Drawing.Size(53, 53);
			this.guna2TileButton1.Location = new System.Drawing.Point(384, 245);
			this.guna2TileButton1.Name = "guna2TileButton1";
			this.guna2TileButton1.Size = new System.Drawing.Size(163, 153);
			this.guna2TileButton1.TabIndex = 29;
			this.guna2TileButton1.Text = "Advanced Tweaks";
			...
			this.guna2TileButton7.Image = Atom_Optimizer.Properties.Resources.speedometer;
			this.guna2TileButton7.ImageSize = new System.Drawing.Size(53, 53);
			this.guna2TileButton7.Location = new System.Drawing.Point(173, 243);
			this.guna2TileButton7.Name = "guna2TileButton7";
			this.guna2TileButton7.Size = new System.Drawing.Size(163, 153);
			this.guna2TileButton7.TabIndex = 28;
			this.guna2TileButton7.Text = "Normal Tweaks";
