...
namespace Atom_Optimizer
{
	public class network : Form
	{
		...
		private void guna2TileButton7_Click(object sender, EventArgs e)
		{
			...
			try
			{
				string text = Path.Combine(Path.GetTempPath(), "adapter.bat");
				using (Stream stream = Assembly.GetExecutingAssembly().GetManifestResourceStream("Atom_Optimizer.adapter.bat"))
				{
		...
		private void guna2TileButton1_Click(object sender, EventArgs e)
		{
			...
			try
			{
				string text = Path.Combine(Path.GetTempPath(), "netowrk.bat");
				using (Stream stream = Assembly.GetExecutingAssembly().GetManifestResourceStream("Atom_Optimizer.netowrk.bat"))
				{
					using (FileStream destination = new FileStream(text, FileMode.Create, FileAccess.Write))
					{
						stream.CopyTo(destination);
		...
		private void InitializeComponent()
		{
			...
			this.label2.Text = "Network Tweaks";
			...
			this.guna2TileButton1.Image = Atom_Optimizer.Properties.Resources.wifi;
			this.guna2TileButton1.ImageSize = new System.Drawing.Size(53, 53);
			this.guna2TileButton1.Location = new System.Drawing.Point(492, 241);
			this.guna2TileButton1.Name = "guna2TileButton1";
			this.guna2TileButton1.Size = new System.Drawing.Size(163, 153);
			this.guna2TileButton1.TabIndex = 28;
			this.guna2TileButton1.Text = "Network Tweaks";
			...
			this.guna2TileButton7.Image = Atom_Optimizer.Properties.Resources.cable;
			this.guna2TileButton7.ImageSize = new System.Drawing.Size(53, 53);
			this.guna2TileButton7.Location = new System.Drawing.Point(281, 241);
			this.guna2TileButton7.Name = "guna2TileButton7";
			this.guna2TileButton7.Size = new System.Drawing.Size(163, 153);
			this.guna2TileButton7.TabIndex = 27;
			this.guna2TileButton7.Text = "Adapter Tweaks";
